function theta6_out = mutate_RS7MSA_phase1(theta6_in, C, p_big)
%MUTATE_RS7MSA_PHASE1  Phase-1 mutation
% theta6 = [Rs, Rsh, Io1, Io2, n1, n2]

    if nargin < 3, p_big = 0.10; end
    ...
    if rand < p_big
        d_rs  = 0.05  * rs_range;
        d_rsh = 0.05  * rsh_range;
        d_n   = 0.20  * n_range;
        d_log = 1.0;
    else
        d_rs  = 0.01  * rs_range;
        d_rsh = 0.005 * rsh_range;
        d_n   = 0.05  * n_range;
        d_log = 0.25;
    end
