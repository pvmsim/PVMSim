...
- **Zenodo archived version:** access the citable archived release of the user manual here:  
  **Osorio, L., Moreno-Espino, M., Duchêne, L., Tuninetti, V., Zalazar Oliva, C., Irarrázaval, R., Retirado Mediaceja, Y., & Rivera, M. (2026). _PVMSim User Manual_ (1.0). Zenodo.**  
  <https://doi.org/10.5281/zenodo.19040391>

## Recommended Use

Use the **GitHub documentation folder** for the most up-to-date project files and supporting material.  
Use the **Zenodo record** when a stable, archived, and citable version of the manual is required.
